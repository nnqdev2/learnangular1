...
namespace OlprrApi.Storage.Repositories
{
    public class OlprrRepository : IOlprrRepository
    {
        ...
        public const string CountiesTable = "CountiesUnsorted";
        ...
        public const string ExecuteApGetLookupTablesByType = "execute dbo.apGetLookupTablesByTypeData {0}";
        ...
        public async Task<IEnumerable<LookUp>> GetAssessmentLookUp()
        {
            return await _dbContext.Set<LookUp>().AsNoTracking().FromSql("execute dbo.apGetLookupTablesAssesementTabData").ToListAsync();
        }
        public async Task<IEnumerable<ApGetLookupTablesByType>> GetLookupTablesByType(string name)
        {
            return await _dbContext.Set<ApGetLookupTablesByType>().AsNoTracking().FromSql(ExecuteApGetLookupTablesByType, name).ToListAsync();
        }
        public async Task<IEnumerable<ApGetLookupTablesByType2>> GetLookupTablesByType2(string name)
        {
            return await _dbContext.Set<ApGetLookupTablesByType2>().AsNoTracking().FromSql(ExecuteApGetLookupTablesByType, name).ToListAsync();
        }
        public async Task<IEnumerable<SearchValue>> SearchWorkReportedBys(string search)
        {
            return await _dbContext.Set<SearchValue>().AsNoTracking().FromSql("execute dbo.apWorkReportedBySearch {0}", search).ToListAsync();
        }
        public async Task<IEnumerable<ActiveProjectManager>> GetActiveProjectManagers()
        {
            return await _dbContext.Set<ActiveProjectManager>().AsNoTracking().FromSql("execute dbo.apGetProjectManagerData").ToListAsync();
        }
        public async Task<int> InsertOLPRRIncidentRecord(ApOlprrInsertIncident apOLPRRInsertIncident)
        {
            ...
            if (icEmailParam.Value == null) icEmailParam.Value = DBNull.Value;
            if (rpAddress2Param.Value == null) rpAddress2Param.Value = DBNull.Value;
        ...
        public async Task<IEnumerable<ApGetLustSearchDataStats>> ApGetLustSearchData(LustSearchFilter lustSearchFilter)
        {
            ...
            var siteCountyParam = new SqlParameter("@SiteCounty", lustSearchFilter.SiteCounty);
            ...
            if (String.IsNullOrEmpty((string) logCountyParam.Value)) logCountyParam.Value = DBNull.Value;
            if (String.IsNullOrEmpty((string) logYearParam.Value)) logYearParam.Value = DBNull.Value;
            if (String.IsNullOrEmpty((string) logSeqNbrParam.Value)) logSeqNbrParam.Value = DBNull.Value;
            if (String.IsNullOrEmpty((string) facilityIdParam.Value)) facilityIdParam.Value = DBNull.Value;
            if (String.IsNullOrEmpty((string) siteNameParam.Value)) siteNameParam.Value = DBNull.Value;
            if (String.IsNullOrEmpty((string) siteAddressParam.Value)) siteAddressParam.Value = DBNull.Value;
            if (String.IsNullOrEmpty((string) siteCityParam.Value)) siteCityParam.Value = DBNull.Value;
            if (String.IsNullOrEmpty((string) siteZipParam.Value)) siteZipParam.Value = DBNull.Value;
            if (String.IsNullOrEmpty((string) siteCountyParam.Value)) siteCountyParam.Value = DBNull.Value;
            if (String.IsNullOrEmpty((string) regionCodeParam.Value)) regionCodeParam.Value = DBNull.Value;
            if (String.IsNullOrEmpty((string) releaseSiteTypeCodeParam.Value)) releaseSiteTypeCodeParam.Value = DBNull.Value;
            if (String.IsNullOrEmpty((string) cleanUpSiteTypeIdParam.Value)) cleanUpSiteTypeIdParam.Value = DBNull.Value;
            if (String.IsNullOrEmpty((string) projectManagerParam.Value)) projectManagerParam.Value = DBNull.Value;
            if (String.IsNullOrEmpty((string) contactFirstNameParam.Value)) contactFirstNameParam.Value = DBNull.Value;
            if (String.IsNullOrEmpty((string) contactLastNameParam.Value)) contactLastNameParam.Value = DBNull.Value;
            if (String.IsNullOrEmpty((string) contactOrganizationParam.Value)) contactOrganizationParam.Value = DBNull.Value;
            ...
            var exeSp = "execute dbo.apGetLustSearchData  @LogCounty, @LogYear, @LogSeqNbr, @FacilityId, @SiteName, @SiteAddress, @SiteCity "
                + ", @SiteZipcode, @SiteCounty, @RegionCode, @ReleaseSiteTypeCode, @CleanUpSiteTypeId, @FileStatusId, @ProjectManagerCode, @ContactFirstName "
            ...
            var result = await _dbContext.Set<ApGetLustSearchData>().AsNoTracking().FromSql(exeSp, logCountyParam, logYearParam, logSeqNbrParam, facilityIdParam
                , siteNameParam, siteAddressParam, siteCityParam, siteZipParam, siteCountyParam, regionCodeParam, releaseSiteTypeCodeParam, cleanUpSiteTypeIdParam
        ...
        public async Task<IEnumerable<ApOlprrGetUstLookupDataStats>> ApOlprrGetUstLookupData(UstSearchFilter ustSearchFilter)
        {
            ...
            var facilityIdParam = new SqlParameter("@FacilityId", ustSearchFilter.FacilityId);
            ...
            var exeSp = "execute dbo.apOLPRRGetUstLookupData  @FacilityName, @FacilityAddress, @FacilityCity, @FacilityZip, @FacilityCounty, @FacilityId "
                + " ,@SortColumn, @SortOrder, @PageNumber, @RowsPerPage, @TotalRows OUTPUT, @TotalPages OUTPUT, @RESULT OUTPUT ";
            ...
            var result = await _dbContext.Set<ApOlprrGetUstLookupData>().AsNoTracking().FromSql(exeSp, facilityNameParam, facilityAddressParam, facilityCityParam, facilityZipParam
                , facilityCountyParam, facilityIdParam, sortColParam, sortOrderParam, pageNumberParam, rowsPerPageParam, totalRowsOutParam, totalPagesOutParam, resultOutParam).ToListAsync();
        ...
        public async Task<OlprrReviewIncidentResult> ApCreateIncidentData (OlprrReviewIncident olprrReviewIncident)
        {
            ...
            var lastChangeByParam = new SqlParameter("@LastChangeby", olprrReviewIncident.LastChangeBy);
            var resultSPParam = new SqlParameter { ParameterName = "@ResultSP", SqlDbType = SqlDbType.Int, Direction = ParameterDirection.Output };

            facilityIdParam.Value = facilityIdParam.Value ?? DBNull.Value;
            ...
            rpStreetParam.Value = rpStreetParam.Value ?? DBNull.Value;
            rpCityParam.Value = rpCityParam.Value ?? DBNull.Value;
            rpStateParam.Value = rpStateParam.Value ?? DBNull.Value;
            rpZipParam.Value = rpZipParam.Value ?? DBNull.Value;
            rpFirstNameParam.Value = rpFirstNameParam.Value ?? DBNull.Value;
            rpLastNameParam.Value = rpLastNameParam.Value ?? DBNull.Value;
            rpOrganizationParam.Value = rpOrganizationParam.Value ?? DBNull.Value;
            ...
            "  , @AppID, @NewSiteStatus, @LastChangeby, @ResultSP";
            ...
            var result = await _dbContext.Database.ExecuteSqlCommandAsync(exeSp, lustIdInParam, facilityIdParam, countyIdParam
                ...
                , appIdParam, newSiteStatusParam, lastChangeByParam, resultSPParam);

...
namespace OlprrApi.Services
{
    public class IncidentReportingService : IIncidentReportingService
    {
        ...
        public async Task<IEnumerable<ProjectManager>> GetProjectManagers()
        {
            ...
            {
                if (!result.ProjectManagerCode.Equals("0"))
        ...
        {
            var resultList = new List<LookUp>();
            foreach (var result in await _lustRepository.GetAssessmentLookUp())
            {
                resultList.Add(_mapper.Map<EntityDto.LookUp, LookUp>(result));
            }
            return resultList;
        }
        ...
        {
            var resultList = new List<ApGetLookupTablesByType>();
            foreach (var result in await _lustRepository.GetLookupTablesByType(name))
            {
                resultList.Add(_mapper.Map<EntityDto.ApGetLookupTablesByType, ApGetLookupTablesByType>(result));
            }
            return resultList;
        }
        ...
        {
            var resultList = new List<ApGetLookupTablesByType2>();
            foreach (var result in await _lustRepository.GetLookupTablesByType2(name))
            {
                resultList.Add(_mapper.Map<EntityDto.ApGetLookupTablesByType2, ApGetLookupTablesByType2>(result));
            }
            return resultList;
        }
        ...
        {
            var resultList = new List<SearchValue>();
            foreach (var result in await _lustRepository.SearchWorkReportedBys(search))
            {
                resultList.Add(_mapper.Map<EntityDto.SearchValue, SearchValue>(result));
            }
            return resultList;
        }
        ...
        {
            var resultList = new List<ActiveProjectManager>();
            foreach (var result in await _lustRepository.GetActiveProjectManagers())
            {
                resultList.Add(_mapper.Map<EntityDto.ActiveProjectManager, ActiveProjectManager>(result));
            }
            return resultList;
        }
    }

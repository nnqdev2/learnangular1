    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<LustDbContext>(options =>
                {
                    //options.UseSqlServer(Configuration.GetConnectionString("LustDbConnection1"), b => b.UseRowNumberForPaging());
            ...
            services.AddScoped<IHotcRepository, HotcRepository>();
            ...
            services.AddScoped<IHotcService, HotcService>();
        }

...
export class OlprrReviewComponent implements OnInit, CanDeactivateGuard {
  ...
  constructor(private lustDataService: LustDataService, private formBuilder: FormBuilder, private datePipe: DatePipe
    ...
    , private acceptedDialog: MatDialog, private pdfService: PdfService, private authService: AuthService
  ) {}
  ...
  private createForm() {
    this.incidentForm = this.formBuilder.group({
      ...
      rpOrganization:   [this.incidentData.rpOrganization, Validators.maxLength(40)],
      ...
      icOrganization:   [this.incidentData.icOrganization, Validators.maxLength(40)],
      ...
      siteZipcode:      [this.incidentData.siteZipcode, Validators.compose([Validators.required, Validators.maxLength(10)
        , Validators.pattern(Constants.zip_format)])],
        sitePhone:        [this.incidentData.sitePhone, Validators.compose([Validators.required, Validators.maxLength(25)])],
    ...
    }, {validator: [ this.olprrPhoneNumberValidation.bind(this),
      this.rpContactPhoneNumberValidation.bind(this),
      this.icContactPhoneNumberValidation.bind(this) ] }
      // this.olprrPhoneNumberValidation.bind(this),
    );
    ...
    if (this.showStatusButtons) {
      if (this.incidentData.releaseTypeCode !== 'H') {
        ...
        // this.incidentForm.controls.icEmail.setValidators([Validators.required]);
          ...
          this.incidentForm.controls.icAddress2.clearValidators();
  ...
  private buildLustIncident() {
    ...
    this.lustIncident.appId = 'LUST' + (this.authService.getUserIdWoDomain());
  ...
  private showMovingOnDialog() {
    ...
    let showLustButton = false;
     if (this.lustIncidentInsertResult.errorMessage != null
      && this.lustIncidentInsertResult.errorMessage !== undefined) {
  ...
  private refreshIcAddressCorrect(addressCorrectData: AddressCorrectStat) {
    ...
    this.incidentForm.controls.icAddressCorrectZipcode.setValue(this.icAddressCorrectStat.Records[0].PostalCode);
  ...
  rpContactPhoneNumberValidation(control: AbstractControl) {
  ...
  icContactPhoneNumberValidation(control: AbstractControl) {
  ...
  olprrPhoneNumberValidation(control: AbstractControl) {

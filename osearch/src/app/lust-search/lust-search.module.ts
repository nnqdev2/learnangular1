...
import { ConsultantSearchResultComponent } from './consultant/consultant-search/consultant-search-result.component';
...
import { PcsPermitEditComponent } from './petroleum-contaminated-soil/pcs-edit/pcs-permit-edit.component';
...
@NgModule({
  ...
  declarations: [ LustSearchComponent, LustIncidentCreateComponent, LustIncidentEditComponent, SearchDialogComponent
                ...
                , SitePhotoBaseComponent, SitePhotoEditComponent, SitePhotosComponent, ConsultantBaseComponent
                , ConsultantSearchFilterComponent, ConsultantSearchResultComponent, ConsultantEditComponent, PcsPermitEditComponent],
